...
#PRODUCE CA WITH PAIRS
#from RecoTracker.CAtracker.GlobalSeedsFromCAPairs_cff import *
## SEEDING LAYERS
...
#from RecoTracker.TkTrackingRegions.GlobalTrackingRegionFromBeamSpot_cfi import RegionPsetFomBeamSpotBlock
#
#initialStepSeedsCA = RecoTracker.CAtracker.GlobalSeedsFromCAPairs_cff.GlobalSeedsFromCAPairs.clone(
#    RegionFactoryPSet = RegionPsetFomBeamSpotBlock.clone(
#    ComponentName = cms.string('GlobalRegionProducerFromBeamSpot'),
#    RegionPSet = RegionPsetFomBeamSpotBlock.RegionPSet.clone(
#    ptMin = 0.6,
...
initialStepTrajectoryFilterBase = TrackingTools.TrajectoryFiltering.TrajectoryFilter_cff.CkfBaseTrajectoryFilter_block.clone(
    minimumNumberOfHits = 5,    #change to 5
    minPt = 0.2
    )

import RecoPixelVertexing.PixelLowPtUtilities.StripSubClusterShapeTrajectoryFilter_cfi
initialStepTrajectoryFilterShapeCA = RecoPixelVertexing.PixelLowPtUtilities.StripSubClusterShapeTrajectoryFilter_cfi.StripSubClusterShapeTrajectoryFilterTIX12.clone()
initialStepTrajectoryFilterCA = cms.PSet(
...
firstStepPrimaryVerticesCA=RecoVertex.PrimaryVertexProducer.OfflinePrimaryVertices_cfi.offlinePrimaryVertices.clone()
firstStepPrimaryVerticesCA.TrackLabel = cms.InputTag("initialStepTracksCA")
firstStepPrimaryVerticesCA.vertexCollections = cms.VPSet(
...
initialStepSelectorCA = RecoTracker.FinalTrackSelectors.multiTrackSelector_cfi.multiTrackSelector.clone(
    ...
    vertices    = cms.InputTag("firstStepPrimaryVerticesCA"),
