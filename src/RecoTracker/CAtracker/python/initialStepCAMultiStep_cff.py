...
CALayersA = RecoTracker.CAtracker.CAPentuplets_cfi.CAPentupletsA.clone()
CALayersBpos = RecoTracker.CAtracker.CAPentuplets_cfi.CAPentupletsB_pos.clone()
CALayersBneg = RecoTracker.CAtracker.CAPentuplets_cfi.CAPentupletsB_neg.clone()
CALayersCpos = RecoTracker.CAtracker.CAPentuplets_cfi.CAPentupletsC_pos.clone()
CALayersCneg = RecoTracker.CAtracker.CAPentuplets_cfi.CAPentupletsC_neg.clone()

from RecoTracker.TkTrackingRegions.GlobalTrackingRegionFromBeamSpot_cfi import RegionPsetFomBeamSpotBlock
from RecoTracker.CAtracker.GlobalSeedsFromMultiplets_cff import *

initialStepSeedsA = RecoTracker.CAtracker.GlobalSeedsFromMultiplets_cff.GlobalSeedsFromMultiplets.clone(
...
initialStepSeedsA.OrderedHitsFactoryPSet.SeedingLayers = 'CALayersA'

initialStepSeedsBpos = RecoTracker.CAtracker.GlobalSeedsFromMultiplets_cff.GlobalSeedsFromMultiplets.clone(
RegionFactoryPSet = RegionPsetFomBeamSpotBlock.clone(
       ComponentName = cms.string('GlobalRegionProducerFromBeamSpot'),
       RegionPSet = RegionPsetFomBeamSpotBlock.RegionPSet.clone(
       		ptMin = 0.6,
...
initialStepSeedsBpos.OrderedHitsFactoryPSet.SeedingLayers = 'CALayersBpos'

initialStepSeedsBneg = RecoTracker.CAtracker.GlobalSeedsFromMultiplets_cff.GlobalSeedsFromMultiplets.clone(
RegionFactoryPSet = RegionPsetFomBeamSpotBlock.clone(
       ComponentName = cms.string('GlobalRegionProducerFromBeamSpot'),
       RegionPSet = RegionPsetFomBeamSpotBlock.RegionPSet.clone(
       		ptMin = 0.6,
...
initialStepSeedsBneg.OrderedHitsFactoryPSet.SeedingLayers = 'CALayersBneg'

initialStepSeedsCneg = RecoTracker.CAtracker.GlobalSeedsFromMultiplets_cff.GlobalSeedsFromMultiplets.clone(
RegionFactoryPSet = RegionPsetFomBeamSpotBlock.clone(
       ComponentName = cms.string('GlobalRegionProducerFromBeamSpot'),
       RegionPSet = RegionPsetFomBeamSpotBlock.RegionPSet.clone(
       		ptMin = 0.6,
...
initialStepSeedsCneg.OrderedHitsFactoryPSet.SeedingLayers = 'CALayersCneg'

initialStepSeedsCpos = RecoTracker.CAtracker.GlobalSeedsFromMultiplets_cff.GlobalSeedsFromMultiplets.clone(
RegionFactoryPSet = RegionPsetFomBeamSpotBlock.clone(
       ComponentName = cms.string('GlobalRegionProducerFromBeamSpot'),
       RegionPSet = RegionPsetFomBeamSpotBlock.RegionPSet.clone(
       		ptMin = 0.6,
...
initialStepSeedsCpos.OrderedHitsFactoryPSet.SeedingLayers = 'CALayersCpos'


import RecoTracker.TkSeedGenerator.GlobalCombinedSeeds_cfi
initialStepSeedsCA = RecoTracker.TkSeedGenerator.GlobalCombinedSeeds_cfi.globalCombinedSeeds.clone()
initialStepSeedsCA.seedCollections = cms.VInputTag(
		 cms.InputTag('initialStepSeedsA'),
         cms.InputTag('initialStepSeedsBpos'),
         cms.InputTag('initialStepSeedsBneg'),
         cms.InputTag('initialStepSeedsCpos'),
         cms.InputTag('initialStepSeedsCneg')
         )
...
initialStepCA = RecoTracker.FinalTrackSelectors.trackListMerger_cfi.trackListMerger.clone(
 ...
 # Final sequence
InitialStepCAPentuplets = cms.Sequence(CALayersA*
                                       initialStepSeedsA*
                                       CALayersBpos*
                                       initialStepSeedsBpos*
                                       CALayersBneg*
                                       initialStepSeedsBneg*
                                       CALayersCpos*
                                       initialStepSeedsCpos*
                                       CALayersCneg*
                                       initialStepSeedsCneg*
                                       initialStepSeedsCA*
